              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">123 Business Park, Nairobi, Kenya</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Phone className="h-6 w-6 text-primary-500 mt-1 mr-3" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail className="h-6 w-6 text-primary-500 mt-1 mr-3" />
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Email</h3>
                    <p className="mt-1 text-gray-600 dark:text-gray-300">info@nyumbasmart.co.ke</p>
                  </div>
                </div>
              </div>
