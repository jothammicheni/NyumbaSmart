      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">{property.roomCount || 0} Units</span>
          </div>
          <div className="flex items-center">
            <Users className="h-5 w-5 text-gray-400 mr-2" />
            <span className="text-sm text-gray-500 dark:text-gray-400">{property.vacantRoomCount || 0} Vacant</span>
          </div>
        </div>
